...
# v = CellVariable(mesh=m, hasOld=True, value=[[A_0], [B_0]], elementshape=(2,))


# eqn = TransientTerm([[1, 0],
#                      [0, 1]]) == DiffusionTerm([[[D_1, 0],
#                                                  [0, D_2]]]) \

# # Default constaints in fipy are zero flux BC
...
#     vi.plot(f"Images/Spatial_ODE/newimage{t}.png")
